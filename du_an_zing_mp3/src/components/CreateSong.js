                            ...
                            <div className="row d-flex align-items-center justify-content-center h-100"
                                ...
                                <div className="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                                    ...
                                    <Form>
                                        ...
                                        <div className="form-outline mb-4" style={{height: 50}}>
                                            <input type="file" id="url_img" className="form-control form-control-lg"
                                                   onChange={(event) => {
                                        ...
                                        <div className="form-outline mb-4" style={{height: 50}}>
                                            <input type="file" id="file_song" className="form-control form-control-lg"
                                                   onChange={(event) => {
                                        ...
                                        <div className="button-create" style={{display: "flex", marginLeft: 100}}>
                                            <div style={{textAlign: "center"}}>
                                                <button type="submit" className="btn btn-primary btn-lg btn-block"
                                                        style={{width: 150}}>Quay lại
                                                </button>
                                            </div>
                                            <div style={{textAlign: "center", paddingLeft: 10}}>
                                                <button type="submit" className="btn btn-primary btn-lg btn-block"
                                                        style={{width: 150}}>Tạo bài
                                                    hát
                                                </button>
                                            </div>
                                        </div>
