...
const SidebarRight = () => {
    ...
    return (
        <div className={"modal"} style={{position: 'fixed',zIndex: '9999',backgroundColor: 'white',padding: '20px',transform: 'translate(-50%, -50%)',left: '50%',top: '50%'}}>
            <div className={"modal-background"} style={{ position: 'fixed',
                top: '0',
                left: '0',
                width: '100%',
                height: '100%',
                backgroundColor: 'rgba(0, 0, 0, 0.5)', /* Màu nền với độ mờ */
                zIndex: '1', /* Đặt z-index thấp hơn so với modal để cho phép thao tác */
                pointerEvents: 'auto'}}>
